...
Inspecting the top 50 occupations, it can be seen that the count of the top 50 occupations has increased from 1373932 to 1708206. Furthermore, some interesting changes would be that CLERK is now the occupation with the largest count, over taking laborer. 
